...
// MIT License
// Copyright (c) 2017 Frederic Branczyk
//
// This application has been derived from https://github.com/brancz/prometheus-example-app
...
func main() {
	...
	foundHandler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Write([]byte("Hello from okra example application."))
	})
